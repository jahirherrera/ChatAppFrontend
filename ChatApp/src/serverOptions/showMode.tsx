...
export default function ShowModerators({ server_id, showing }: showMode) {
    ...
    return (
        <>
            <div className={`fixed top-0 left-0 w-full h-full bg-gray-900/80 flex justify-center items-center text-[var(--text)] `}>
                <div className='bg-gradient-to-tl from-[var(--chat)] to-[var(--chat)]/80 p-6 rounded-lg w-120 h-70 grid grid-rows-[1fr_10fr]'>
